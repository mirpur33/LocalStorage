// let myapiKey = "92aa4fc0f53c0e96e588c41ac3e76efb"; ' New API key will be updated. Currently not working'
...
// Set up arrays of references to HTML elements - Suggested by tutor
var cityDayEl = [
...
// Full tutor session applied and taken the idea to create functions //
...
// New API key updated to check the status and functions //

var apiKey = "29c1a7e7a33d36b071d80aa75f16b7bb";
var cities=[];
var city_history=[];
var temps=[6];
var humids=[6];
...
function getLocation(city) {
  ...
  // Fetch data from the API and return an object
...
// Thank God. It is finally working. Thank you. //